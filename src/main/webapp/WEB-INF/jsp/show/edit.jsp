...
<body>
    ...
    <form:form method="post" commandName="info">
        ...
        <div class="form-group">
            <form:label path="name">人员名称：</form:label>
            <form:input path="name"/>
        </div>

        <div class="form-group">
            <form:label path="phoneNumbe">人员电话：</form:label>
            <form:password path="phoneNumbe"/>
        </div>
        <c:if test="${op ne '修改'}">
	        <div class="form-group">
	            <form:label path="time">人员安排时间：</form:label>
	            <form:password path="time"/>
	        </div>
        </c:if>
